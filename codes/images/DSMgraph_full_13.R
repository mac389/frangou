...
for (i in 1:r){V(g)$SOP[i]<-common[i,4]}

V(g)$color<-"white"
V(g)[ SOP  == "1" ]$color <- "green"
...
title ("DSMgraph_full_13")
legend (50,90, c("Symptom is not a symptom of Social Phobia",
    "Symptom is a symptom of Social Phobia"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Social Phobia",
    "Symptom is a symptom of Social Phobia"), col= c("black") ,pch = 1, xjust=0.5)
