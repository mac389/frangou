...
title ("DSMgraph_full_10")
legend (50,90, c("Symptom is not a symptom of Major Depressive Episode",
    "Symptom is a symptom of Major Depressive Episode"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Major Depressive Episode",
    "Symptom is a symptom of Major Depressive Episode"), col= c("black") ,pch = 1, xjust=0.5)
