...
for (i in 1:r){V(g)$SIP[i]<-common[i,5]}

V(g)$color<-"white"
V(g)[ SIP   == "1" ]$color <- "green"
...
title ("DSMgraph_full_14")
legend (50,90, c("Symptom is not a symptom of Simple Phobia",
    "Symptom is a symptom of Simple Phobia"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Simple Phobia",
    "Symptom is a symptom of Simple Phobia"), col= c("black") ,pch = 1, xjust=0.5)
