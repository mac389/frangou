...
title ("DSMgraph_full_15")
legend (50,90, c("Symptom is not a symptom of Generalized Anxiety Disorder",
    "Symptom is a symptom of Generalized Anxiety Disorder"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Generalized Anxiety Disorder",
    "Symptom is a symptom of Generalized Anxiety Disorder"), col= c("black") ,pch = 1, xjust=0.5)
