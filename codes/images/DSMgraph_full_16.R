...
for (i in 1:r){V(g)$PD[i]<-common[i,7]}

V(g)$color<-"white"
V(g)[ PD == "1" ]$color <- "green"
...
title ("DSMgraph_full_16")
legend (50,90, c("Symptom is not a symptom of Panic Disorder",
    "Symptom is a symptom of Panic Disorder"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Panic Disorder",
    "Symptom is a symptom of Panic Disorder"), col= c("black") ,pch = 1, xjust=0.5)
