...
for (i in 1:r){V(g)$DYS[i]<-common[i,2]}

V(g)$color<-"white"
V(g)[ DYS == "1" ]$color <- "green"
...
title ("DSMgraph_full_11")
legend (50,90, c("Symptom is not a symptom of Dysthymia",
    "Symptom is a symptom of Dysthymia"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Dysthymia",
    "Symptom is a symptom of Dysthymia"), col= c("black") ,pch = 1, xjust=0.5)
