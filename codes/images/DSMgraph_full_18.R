...
for (i in 1:r){V(g)$APD[i]<-common[i,10]}

V(g)$color<-"white"
V(g)[ APD == "1" ]$color <- "green"
...
title ("DSMgraph_full_18")
legend (50,90, c("Symptom is not a symptom of Antisocial Personality Disorder",
    "Symptom is a symptom of Antisocial Personality Disorder"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Antisocial Personality Disorder",
    "Symptom is a symptom of Antisocial Personality Disorder"), col= c("black") ,pch = 1, xjust=0.5)
