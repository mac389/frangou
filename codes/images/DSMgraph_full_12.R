...
for (i in 1:r){V(g)$AGPH[i]<-common[i,3]}

V(g)$color<-"white"
V(g)[ AGPH == "1" ]$color <- "green"
...
title ("DSMgraph_full_12")
legend (50,90, c("Symptom is not a symptom of Agoraphobia",
    "Symptom is a symptom of Agoraphobia"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Agoraphobia",
    "Symptom is a symptom of Agoraphobia"), col= c("black") ,pch = 1, xjust=0.5)
