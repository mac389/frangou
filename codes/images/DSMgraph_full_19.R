...
for (i in 1:r){V(g)$DD[i]<-common[i,9]}

V(g)$color<-"white"
V(g)[ DD == "1" ]$color <- "green"
...
title ("DSMgraph_full_19")
legend (50,90, c("Symptom is not a symptom of Drug Dependence",
    "Symptom is a symptom of Drug Dependence"), col= c("white","green") ,pch = 19, xjust=0.5)
legend (50,90, c("Symptom is not a symptom of Drug Dependence",
    "Symptom is a symptom of Drug Dependence"), col= c("black") ,pch = 1, xjust=0.5)
